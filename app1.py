...
if page == "Dashboard":
    ...
    min_age = st.sidebar.number_input("Minimum Age", value=None)
    max_age = st.sidebar.number_input("Maximum Age", value=None)

    st.sidebar.subheader("Monthly Income Range")

    min_income = st.sidebar.number_input("Minimum Income", value=None, step=500)
    max_income = st.sidebar.number_input("Maximum Income", value=None, step=500)
